...
function startConversation() {
    fetch('https://chatbot-for-hudson-childrens-academy-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
  ...
  //sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-hudson-childrens-academy-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycbwnQUVERssPuVybj08BqkXHzt_LiyrF2HoCYuN5SLgk6_a1suSwO8VHlv2hkFrUWqSl/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbz8Exts_DOQp8h8jzLOPN6D1meTiE_byPJiffcg_ICO2LRkjESWcVQERZo65sZffRZJ/exec';
